...
const CREDENTIALS_PATH = 'src/recursos_para_gmail_api/send-mail-example/credentials.json';
const TOKEN_PATH = 'src/recursos_para_gmail_api/send-mail-example/token.json';
